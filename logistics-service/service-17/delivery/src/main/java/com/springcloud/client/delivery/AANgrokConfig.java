...
@Component()
public class AANgrokConfig {

    private final ObjectMapper objectMapper = new ObjectMapper();
    private static final String DEFAULT_HOST = "localhost:8080"; // 예외 발생 시 사용할 기본 값
    ...
    public void init() {
        try {
            ...
            String ngrokUrl = jsonNode.path("tunnels").get(1).path("public_url").asText();
